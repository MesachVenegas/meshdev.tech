  ...
  return (
    <Timeline>
      ...
      <Timeline.Item>
        ...
        <Timeline.Content>
          <Timeline.Time className='text-rose-500 dark:text-cyan-400 font-medium ml-6'>
            Abril 2021 - Junio 2021
          </Timeline.Time>
          <Timeline.Title className={`${encode_sans.className} flex gap-2`}>
            <Image src="/assets/udemy.svg" width={40} height={40} alt='Academlo logo' />
            Universidad Python
          </Timeline.Title>
          <Timeline.Body >
      ...
      <Timeline.Item className='text-black/70 dark:text-white'>
        <Timeline.Point icon={HiCalendar} />
        <Timeline.Content>
          <Timeline.Time className='text-rose-500 dark:text-cyan-400 font-medium ml-6'>
          ...
          <Timeline.Title className={`${encode_sans.className} flex gap-2 items-center`} >
            <Image src="/assets/inovacion.webp" width={40} height={40} alt='Academlo logo' />
            Launch X
          </Timeline.Title>
          <Timeline.Body>
      ...
      <Timeline.Item>
        ...
        <Timeline.Content>
          ...
          <Timeline.Title className={`${encode_sans.className} flex gap-2 items-center`}>
            <Image src="/assets/academlo_logo.png" width={50} height={50} alt='Academlo logo' />
            Academlo
          </Timeline.Title>
          <Timeline.Body>
      ...
      <Timeline.Item>
        ...
        <Timeline.Content>
          ...
          <Timeline.Title className={`${encode_sans.className} flex gap-2 items-center`} >
            <Image src="/assets/codefy.png" width={60} height={60} alt='Academlo logo' />
            Codefy +
          </Timeline.Title>
          <Timeline.Body>
